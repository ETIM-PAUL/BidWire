...
export function FollowUpDrafts({ project }: { project: Doc<'projects'> }) {
  ...
  return (
    <div className="space-y-3 border-t border-neutral-900 pt-4">
      <h3 className="text-sm font-medium text-amber-400">
        Follow-up nudges ready ({pendingDrafts.length})
      </h3>
      <p className="text-xs text-neutral-500">
        These suppliers haven't replied. Review and send a reminder, or discard it.
      </p>
