...
export function ProjectPage() {
  ...
  return <div className="min-h-screen bg-[#070908] text-neutral-100">
    ...
    <div className="mx-auto grid max-w-[1440px] grid-cols-1 lg:grid-cols-[minmax(0,1fr)_300px]">
      <main className="min-w-0 px-4 py-6 sm:px-6 sm:py-8">{tab === 'Materials' && <MaterialsTab project={project} />}{tab === 'Suppliers' && <SuppliersTab project={project} />}{tab === 'Inbox' && <InboxTab project={project} />}{tab === 'Compare' && <CompareTab project={project} />}</main>
